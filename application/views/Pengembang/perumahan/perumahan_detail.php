					...
					<form class="form-horizontal p20" autocomplete="off" enctype="multipart/form-data">
						...
						<div class="box-body box-append">
							<div class="title-form-sect">
								Sarana & Prasarana
									<a class="pull-right" href="<?php echo site_url('pengembang/sarana_edit/'.$row->id_bangunan); ?>">
						...
						<div class="box-body box-append">
							<div class="title-form-sect">
								Fasilitas
									<a class="pull-right" href="<?php echo site_url('pengembang/fasilitas_edit/'.$row->id_bangunan); ?>">
										<i class="fa fa-pencil"></i> Ubah
									</a>
							</div>
							<table class="tb-perum-desk table table-bordered">
						...
						<div class="box-body box-append">
							<div class="title-form-sect">
								Foto
								<a class="pull-right" href="<?php echo site_url('pengembang/fotobangunan_edit/'.$row->id_bangunan); ?>">
										<i class="fa fa-pencil"></i> Ubah
								</a>
							</div>
							<table class="tb-perum-desk table table-bordered">
