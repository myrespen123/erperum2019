	...
	<div class="content-wrapper">
		<div class="content-header">
			<div class="container-fluid">
				<div class="row mb-2">
					<div class="col-sm-6">
						<h1>Data properti <?= $row_perum->nama_perumahan ?></h1>
					</div>
					<div class="col-sm-6">
									...
									<?php foreach ($data as $key => $value): ?>
										<tr>
											...
											<td class="text-center">
												...
												<!-- <a class="ms5 btn button-edit" href="<?php echo site_url('admins/properti_edit/'.$value['id_bangunan']) ?>">
													<i class="fa fa-pencil"></i>
												</a> -->
											<!-- 	<a class="ms5 btn button-delete" href="<?php echo site_url('admins/properti_delete/'.$value['id_bangunan']) ?>" onclick="return confirm('Ingin menghapus data ?');">
