												...
												<div class="inner-box col-sm-11">
													<div class="button-group text-center">
														<?php if ($row->status_publish == 0): ?>
															<a href="<?= site_url('admins/properti_confirm_action/'.$row->id_bangunan); ?>" class="m-s-10 btn status-green color-hover-white" onclick="return confirm('Ingin konfirmasi data ?');">KONFIRMASI</a>
															<?php else: ?>
															<a href="<?= site_url('admins/properti_confirm_action/'.$row->id_bangunan); ?>" class="m-s-10 btn status-red color-hover-white" onclick="return confirm('Ingin BATALKAN konfirmasi data ?');">
																BATALKAN KONFIRMASI
															</a>
														<?php endif ?>
													</div>
