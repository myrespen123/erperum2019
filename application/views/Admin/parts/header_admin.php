      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          <a href="<?php echo site_url('Admin/data_perumahan'); ?>">
            <i class="fa fa-institution"></i> <span>Data Perumahan</span>
          </a>
        </li>
        <li>
          <a href="<?php echo base_url('Admin/data_pengembang'); ?>">
            <i class="fa fa-users"></i> <span>Pengembang</span>
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="<?php echo site_url('admin/laporan_progres') ?>">
            <i class="fa fa-book"></i> <span>Laporan Progress</span>
          </a>
        </li>
        <li>
          <a href="<?php echo site_url('Admin/data_kontak'); ?>">
