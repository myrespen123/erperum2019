				...
				<div class="box">
					...
					<div class="box-body table-responsive">
						<table id="dtable" class="dtable table table-bordered table-striped">
							...
							<tbody>
								<?php foreach ($data as $databg => $val_bg): ?>
					                <tr>
										<td><?= $databg+1; ?></td>
										<td><?= $val_bg['judul']; ?></td>
										<td>
											<img src="<?php echo base_url('file/main/images/'.$val_bg['foto']) ?>" class="img-tbl">
										</td>
										<td>
											<div class="dropdown show">
											  ...
											  <div class="dropdown-menu dropdown-button" aria-labelledby="dropdownMenuLink">
											    <a class="m-s-5" href="<?php echo site_url('operator/background_edit/'.$val_bg['id_main_bg']); ?>">
